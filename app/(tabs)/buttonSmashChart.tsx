...
export default function AnalyticsScreen() {
  ...
  useEffect(() => {
    const fetchScoreData = fetch('https://parkinsonschartsbackend.onrender.com/buttonSmash/latest/5').then(res => res.json());
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Button Smashes Trend</Text>
      {loading ? (
