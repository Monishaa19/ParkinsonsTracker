...
export default function AnalyticsScreen() {
  ...
  useEffect(() => {
    const fetchScoreData = fetch('https://parkinsonschartsbackend.onrender.com/connectTheDots/latest/5').then(res => res.json());
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Connect The Dots Score Trend</Text>
      {loading ? (
