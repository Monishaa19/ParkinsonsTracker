...
export default function AnalyticsScreen() {
  ...
  useEffect(() => {
    const fetchScoreData = fetch('https://parkinsonschartsbackend.onrender.com/jitteryLine/latest/5').then(res => res.json());
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Jitter Score Trend</Text>
      {loading ? (
