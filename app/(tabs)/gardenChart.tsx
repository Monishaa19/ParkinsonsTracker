...
export default function AnalyticsScreen() {
  ...
  useEffect(() => {
    ...
    const fetchTimeData = fetch('https://parkinsonschartsbackend.onrender.com/garden/latest/5').then(res => res.json());
    ...
    <ScrollView style={styles.container}>
      ...
      {loading ? (
        ...
        <>
          ...
          <Text style={styles.title}>Garden Time Taken Trend</Text>
          <LineChart
            data={{
              labels: ['1', '2', '3', '4', '5'],
              datasets: [{ data: times }]
