...
# Paths
images_folder = r"c:\Documents\ParkinsonsTracker\lines"
smoothness_file = os.path.join(images_folder, "lines.txt")
...
# Example: Predict smoothness for a new image
for i in range(1, 11):
    new_image_path = rf"c:\Documents\ParkinsonsTracker\lines\{i}.png"
